...
class GCPCloudSQLProvider:
    ...
    def get_database_connection_info(self, instance_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            return {
                "host": instance.ip_addresses[0].ip_address if instance.ip_addresses else None,
                "port": instance.settings.ip_configuration.ipv4_enabled and 5432 or None,
                "engine": instance.database_version,
            }
        except Exception:
            return None

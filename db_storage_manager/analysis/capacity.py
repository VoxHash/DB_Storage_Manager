...
class CapacityPlanner:
    ...
    def calculate_capacity_utilization(self, analysis: StorageAnalysis, total_capacity: int) -> Dict[str, Any]:
        """Calculate current capacity utilization"""
        current_size = analysis.get("totalSize", 0)
        utilization_percent = (current_size / total_capacity * 100) if total_capacity > 0 else 0
        
        status = "critical" if utilization_percent > 90 else "warning" if utilization_percent > 75 else "healthy"
    ...
    def estimate_time_to_capacity(self, total_capacity: int, threshold_percent: float = 90.0) -> Dict[str, Any]:
        ...
        estimated_days = int(remaining_space / daily_growth) if daily_growth > 0 else None
    ...
    def get_capacity_recommendations(self, analysis: StorageAnalysis, total_capacity: int) -> List[Dict[str, Any]]:
    ...
    def generate_capacity_report(self, analysis: StorageAnalysis, total_capacity: int) -> Dict[str, Any]:

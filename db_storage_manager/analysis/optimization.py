...
class IndexOptimizer:
    ...
    async def _analyze_postgres_indexes(self, analysis: StorageAnalysis) -> List[Dict[str, Any]]:
        ...
        for table in analysis.get("tables", []):
            table_indexes = [
                idx for idx in analysis.get("indexes", [])
    ...
    async def _analyze_mysql_indexes(self, analysis: StorageAnalysis) -> List[Dict[str, Any]]:
    ...
    async def _analyze_sqlserver_indexes(self, analysis: StorageAnalysis) -> List[Dict[str, Any]]:
    ...
    async def get_optimization_recommendations(self, analysis: StorageAnalysis) -> Dict[str, Any]:
